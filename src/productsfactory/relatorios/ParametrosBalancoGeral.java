 ...
 * @author Daniel
 */
public class ParametrosBalancoGeral extends javax.swing.JDialog {

    private static ParametrosBalancoGeral jDialogParametros = null;

    public static ParametrosBalancoGeral getDialogParametros(java.awt.Frame janela){

        if (jDialogParametros == null) {
            jDialogParametros = new ParametrosBalancoGeral(janela,true);
        }
        return jDialogParametros;
    }
    /** Creates new form ParametrosAlunoAtivoInativo */
    public ParametrosBalancoGeral(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inicializa();
    }
...
// TODO add your handling code here:
    ...
    private void reportDespesa(){
             ...
             if(this.dtInicioPeriodo.getDate().after(this.dtTerminoPeriodo.getDate())){
                ...
                RelatorioBalancoGeral  relatorioBalancoGeral = new RelatorioBalancoGeral(this, true);
                this.dispose();
                relatorioBalancoGeral.geraRelatorio(this.dtInicioPeriodo.getDate(), this.dtTerminoPeriodo.getDate());
            }
