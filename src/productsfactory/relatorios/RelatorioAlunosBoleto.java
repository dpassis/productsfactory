 ...
 * @author Daniel
 */
public class RelatorioAlunosBoleto extends javax.swing.JDialog {

    
    /** Creates new form RelatorioTodosAlunos */
    public RelatorioAlunosBoleto(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void geraRelatorio(String situacaoBoleto) {  
        try {
               ...
               JasperPrint jp;
               URL arquivo = getClass().getResource("/sistemaoficinamusica/report/alunosSituacaoBoletos.jasper");
               ...
               if (jp.getPages().isEmpty()) {
                   ...
                   jpv.setTitle("Alunos Situação Boleto");
                   jpv.setAlwaysOnTop(true);
                   jpv.setVisible(true);
               }
        } catch (JRException ex) {
            Logger.getLogger(RelatorioAlunosBoleto.class.getName()).log(Level.SEVERE, null, ex);
        }
