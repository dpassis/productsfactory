 ...
 * @author Daniel
 */
public class ParametrosAlunosInadimplentes extends javax.swing.JDialog {

    private static ParametrosAlunosInadimplentes jDialogParametros = null;

    public static ParametrosAlunosInadimplentes getDialogParametros(java.awt.Frame janela){

        if (jDialogParametros == null) {
            jDialogParametros = new ParametrosAlunosInadimplentes(janela,true);
        }
        return jDialogParametros;
    }
    /** Creates new form ParametrosAlunoAtivoInativo */
    public ParametrosAlunosInadimplentes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inicializa();
    }
...
// TODO add your handling code here:
    ...
    private void reportDespesa(){
             ...
             if(this.dtInicioPeriodo.getDate().after(this.dtTerminoPeriodo.getDate())){
                ...
                RelatorioAlunosInadimplentes  relatorioAlunosInadimplentes = new RelatorioAlunosInadimplentes(this, true);
                this.dispose();
                relatorioAlunosInadimplentes.geraRelatorio(this.dtInicioPeriodo.getDate(), this.dtTerminoPeriodo.getDate());
            }
