 ...
 * @author Daniel
 */
public class RelatorioAlunosProfessor extends javax.swing.JDialog {

    
    /** Creates new form RelatorioTodosAlunos */
    public RelatorioAlunosProfessor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void geraRelatorio() {  
        try {
               ...
               JasperPrint jp;
               URL arquivo = getClass().getResource("/sistemaoficinamusica/report/alunosProfessor.jasper");
               ...
               if (jp.getPages().isEmpty()) {
                   ...
                   jpv.setTitle("Alunos por Professor");
                   jpv.setAlwaysOnTop(true);
                   jpv.setVisible(true);
               }
        } catch (JRException ex) {
            Logger.getLogger(RelatorioAlunosProfessor.class.getName()).log(Level.SEVERE, null, ex);
        }
