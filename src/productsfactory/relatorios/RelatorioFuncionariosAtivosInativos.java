 ...
 * @author Daniel
 */
public class RelatorioFuncionariosAtivosInativos extends javax.swing.JDialog {
    private static RelatorioFuncionariosAtivosInativos jDialogReport = null;

    public static RelatorioFuncionariosAtivosInativos getDialogAlunos(java.awt.Frame janela,boolean modal) {

        if (jDialogReport == null) {
            jDialogReport = new RelatorioFuncionariosAtivosInativos(janela, modal);
        }
        return jDialogReport;
    }
    /** Creates new form RelatorioAlunosAtivosInativos */
    public RelatorioFuncionariosAtivosInativos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        addWindowListener();
    }
...
public void geraRelatorio(String status) {  
        try {
               ...
               JasperPrint jp;
               URL arquivo = getClass().getResource("/sistemaoficinamusica/report/funcionariosAtivosInativos.jasper");
            ...
            Logger.getLogger(RelatorioFuncionariosAtivosInativos.class.getName()).log(Level.SEVERE, null, ex);
        }
