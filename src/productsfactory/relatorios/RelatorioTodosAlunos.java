 ...
 * @author Daniel
 */
public class RelatorioTodosAlunos extends javax.swing.JDialog {

    
    /** Creates new form RelatorioTodosAlunos */
    public RelatorioTodosAlunos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void geraRelatorio() {  
        try {
               ...
               JasperPrint jp;
               URL arquivo = getClass().getResource("/sistemaoficinamusica/report/todosAlunos.jasper");
            ...
            Logger.getLogger(RelatorioTodosAlunos.class.getName()).log(Level.SEVERE, null, ex);
        }
