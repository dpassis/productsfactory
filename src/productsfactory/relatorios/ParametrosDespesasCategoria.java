 ...
 * @author Daniel
 */
public class ParametrosDespesasCategoria extends javax.swing.JDialog {

    private static ParametrosDespesasCategoria jDialogParametros = null;

    public static ParametrosDespesasCategoria getDialogParametros(java.awt.Frame janela){

        if (jDialogParametros == null) {
            jDialogParametros = new ParametrosDespesasCategoria(janela,true);
        }
        return jDialogParametros;
    }
    /** Creates new form ParametrosAlunoAtivoInativo */
    public ParametrosDespesasCategoria(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inicializa();
    }
...
// TODO add your handling code here:
    ...
    private void reportDespesa(){
             ...
             if(this.dtInicioPeriodo.getDate().after(this.dtTerminoPeriodo.getDate())){
                ...
                RelatorioDespesasCategoria  relatorioDespesasCategoria = new RelatorioDespesasCategoria(this, true);
                this.dispose();
                relatorioDespesasCategoria.geraRelatorio(this.dtInicioPeriodo.getDate(), this.dtTerminoPeriodo.getDate());
            }
