 ...
 * @author Daniel
 */
public class ParametrosIniciantesCurso extends javax.swing.JDialog {

    private static ParametrosIniciantesCurso jDialogParametros = null;

    public static ParametrosIniciantesCurso getDialogParametros(java.awt.Frame janela){

        if (jDialogParametros == null) {
            jDialogParametros = new ParametrosIniciantesCurso(janela,true);
        }
        return jDialogParametros;
    }
    /** Creates new form ParametrosAlunoAtivoInativo */
    public ParametrosIniciantesCurso(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inicializa();
    }
...
// TODO add your handling code here:
    ...
    private void geraReport(){
            ...
            if(this.dtInicioPeriodo.getDate().after(this.dtTerminoPeriodo.getDate())){
                ...
                RelatorioIniciantesCurso  relatorioIniciantesCurso = new RelatorioIniciantesCurso(this, true);
                this.dispose();
                relatorioIniciantesCurso.geraRelatorio(this.dtInicioPeriodo.getDate(), this.dtTerminoPeriodo.getDate());
            }
