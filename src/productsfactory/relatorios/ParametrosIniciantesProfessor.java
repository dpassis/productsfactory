 ...
 * @author Daniel
 */
public class ParametrosIniciantesProfessor extends javax.swing.JDialog {

    private static ParametrosIniciantesProfessor jDialogParametros = null;

    public static ParametrosIniciantesProfessor getDialogParametros(java.awt.Frame janela){

        if (jDialogParametros == null) {
            jDialogParametros = new ParametrosIniciantesProfessor(janela,true);
        }
        return jDialogParametros;
    }
    /** Creates new form ParametrosAlunoAtivoInativo */
    public ParametrosIniciantesProfessor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inicializa();
    }
...
// TODO add your handling code here:
    ...
    private void geraReport(){
            ...
            if(this.dtInicioPeriodo.getDate().after(this.dtTerminoPeriodo.getDate())){
                ...
                RelatorioIniciantesProfessor  relatorioIniciantesProfessor= new RelatorioIniciantesProfessor(this, true);
                this.dispose();
                relatorioIniciantesProfessor.geraRelatorio(this.dtInicioPeriodo.getDate(), this.dtTerminoPeriodo.getDate());
            }
