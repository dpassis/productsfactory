 ...
 * @author Daniel
 */
public class RelatorioDesistentesCurso extends javax.swing.JDialog {

    
    /** Creates new form RelatorioTodosAlunos */
    public RelatorioDesistentesCurso(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void geraRelatorio(Date dataInicio, Date dataFim) {  
        try {
               ...
               JasperPrint jp;
               URL arquivo = getClass().getResource("/sistemaoficinamusica/report/alunosDesistentesCurso.jasper");
            ...
            Logger.getLogger(RelatorioDesistentesCurso.class.getName()).log(Level.SEVERE, null, ex);
        }
