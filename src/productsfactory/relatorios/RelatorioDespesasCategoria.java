 ...
 * @author Daniel
 */
public class RelatorioDespesasCategoria extends javax.swing.JDialog {

    
    /** Creates new form RelatorioTodosAlunos */
    public RelatorioDespesasCategoria(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void geraRelatorio(Date dataInicio, Date dataFim) {  
        try {
               ...
               JasperPrint jp;
               URL arquivo = getClass().getResource("/sistemaoficinamusica/report/despesasCategoria.jasper");
            ...
            Logger.getLogger(RelatorioDespesasCategoria.class.getName()).log(Level.SEVERE, null, ex);
        }
