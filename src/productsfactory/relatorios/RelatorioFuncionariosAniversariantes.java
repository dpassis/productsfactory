 ...
 * @author Daniel
 */
public class RelatorioFuncionariosAniversariantes extends javax.swing.JDialog {

    
    /** Creates new form RelatorioTodosAlunos */
    public RelatorioFuncionariosAniversariantes(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void geraRelatorio(String mesNumber, String mesChar) {  
        try {
               ...
               JasperPrint jp;
               URL arquivo = getClass().getResource("/sistemaoficinamusica/report/funcionariosAniversariantes.jasper");
               ...
               parametros.put("mesNumber", mesNumber);
               parametros.put("mesChar", mesChar);
               ...
               if (jp.getPages().isEmpty()) {
                   ...
                   jpv.setTitle("Funcionários Aniversariantes");
                   jpv.setAlwaysOnTop(true);
                   jpv.setVisible(true);
               }
        } catch (JRException ex) {
            Logger.getLogger(RelatorioFuncionariosAniversariantes.class.getName()).log(Level.SEVERE, null, ex);
        }
