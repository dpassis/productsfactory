 ...
 * @author Daniel
 */
public class ParametrosTodasDespesas extends javax.swing.JDialog {

    private static ParametrosTodasDespesas jDialogParametros = null;

    public static ParametrosTodasDespesas getDialogParametro(java.awt.Frame janela){

        if (jDialogParametros == null) {
            jDialogParametros = new ParametrosTodasDespesas(janela,true);
        }
        return jDialogParametros;
    }
    /** Creates new form ParametrosAlunoAtivoInativo */
    public ParametrosTodasDespesas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inicializa();
    }
...
// TODO add your handling code here:
    ...
    private void reportDespesa(){
            ...
            if(this.dtInicioPeriodo.getDate().after(this.dtTerminoPeriodo.getDate())){
                ...
                RelatorioTodasDespesas relatorioTodasDespesas = new RelatorioTodasDespesas(this, true);
                this.dispose();
                relatorioTodasDespesas.geraRelatorio(this.dtInicioPeriodo.getDate(), this.dtTerminoPeriodo.getDate());
            }
