 ...
 * @author Daniel
 */
public class RelatorioAlunosAniversariantes extends javax.swing.JDialog {

    
    /** Creates new form RelatorioTodosAlunos */
    public RelatorioAlunosAniversariantes(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void geraRelatorio(String mesNumber, String mesChar) {  
        try {
               ...
               JasperPrint jp;
               URL arquivo = getClass().getResource("/sistemaoficinamusica/report/alunosAniversariantes.jasper");
               ...
               if (jp.getPages().isEmpty()) {
                   ...
                   jpv.setTitle("Alunos Aniversariantes");
                   jpv.setAlwaysOnTop(true);
                   jpv.setVisible(true);
               }
        } catch (JRException ex) {
            Logger.getLogger(RelatorioAlunosAniversariantes.class.getName()).log(Level.SEVERE, null, ex);
        }
