 ...
 * @author Daniel
 */
public class ParametrosFuncionariosAniversariantes extends javax.swing.JDialog {

    private static ParametrosFuncionariosAniversariantes jDialogParametros = null;

    public static ParametrosFuncionariosAniversariantes getDialogParametro(java.awt.Frame janela){

        if (jDialogParametros == null) {
            jDialogParametros = new ParametrosFuncionariosAniversariantes(janela,true);
        }
        return jDialogParametros;
    }
    /** Creates new form ParametrosAlunoAtivoInativo */
    public ParametrosFuncionariosAniversariantes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inicializa();
    }
    ...
    private void initComponents() {
        ...
        dtMes.setFont(new java.awt.Font("Tahoma", 1, 12));
...
// TODO add your handling code here:
  this.selecionaMes();
    ...
    private void selecionaMes(){
        ...
        RelatorioFuncionariosAniversariantes openRelatorio = new RelatorioFuncionariosAniversariantes(this,true);
        this.dispose();
