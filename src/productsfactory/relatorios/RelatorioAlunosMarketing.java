 ...
 * @author Daniel
 */
public class RelatorioAlunosMarketing extends javax.swing.JDialog {

    
    /** Creates new form RelatorioTodosAlunos */
    public RelatorioAlunosMarketing(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void geraRelatorio() {  
        try {
               ...
               JasperPrint jp;
               URL arquivo = getClass().getResource("/sistemaoficinamusica/report/alunosMidia.jasper");
            ...
            Logger.getLogger(RelatorioAlunosMarketing.class.getName()).log(Level.SEVERE, null, ex);
        }
