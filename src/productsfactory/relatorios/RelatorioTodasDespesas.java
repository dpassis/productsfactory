 ...
 * @author Daniel
 */
public class RelatorioTodasDespesas extends javax.swing.JDialog {

    
    /** Creates new form RelatorioTodosAlunos */
    public RelatorioTodasDespesas(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void geraRelatorio(Date dataInicio, Date dataFim) {  
        try {
               ...
               JasperPrint jp;
               URL arquivo = getClass().getResource("/sistemaoficinamusica/report/todasDespesas.jasper");
            ...
            Logger.getLogger(RelatorioTodasDespesas.class.getName()).log(Level.SEVERE, null, ex);
        }
