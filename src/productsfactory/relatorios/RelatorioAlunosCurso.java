 ...
 * @author Daniel
 */
public class RelatorioAlunosCurso extends javax.swing.JDialog {

    
    /** Creates new form RelatorioTodosAlunos */
    public RelatorioAlunosCurso(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void geraRelatorio() {  
        try {
               ...
               JasperPrint jp;
               URL arquivo = getClass().getResource("/sistemaoficinamusica/report/alunosCurso.jasper");
               ...
               if (jp.getPages().isEmpty()) {
                   ...
                   jpv.setTitle("Alunos por Curso");
                   jpv.setAlwaysOnTop(true);
                   jpv.setVisible(true);
               }
        } catch (JRException ex) {
            Logger.getLogger(RelatorioAlunosCurso.class.getName()).log(Level.SEVERE, null, ex);
        }
