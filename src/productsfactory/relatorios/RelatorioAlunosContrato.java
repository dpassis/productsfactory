 ...
 * @author Daniel
 */
public class RelatorioAlunosContrato extends javax.swing.JDialog {

    
    /** Creates new form RelatorioTodosAlunos */
    public RelatorioAlunosContrato(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void geraRelatorio() {  
        try {
               ...
               JasperPrint jp;
               URL arquivo = getClass().getResource("/sistemaoficinamusica/report/alunosSituacaoContrato.jasper");
               ...
               if (jp.getPages().isEmpty()) {
                   ...
                   jpv.setTitle("Alunos sem Contrato");
                   jpv.setAlwaysOnTop(true);
                   jpv.setVisible(true);
               }
        } catch (JRException ex) {
            Logger.getLogger(RelatorioAlunosContrato.class.getName()).log(Level.SEVERE, null, ex);
        }
