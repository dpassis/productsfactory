 ...
 * @author Daniel
 */
public class RelatorioDespesasSituacao extends javax.swing.JDialog {

    
    /** Creates new form RelatorioTodosAlunos */
    public RelatorioDespesasSituacao(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void geraRelatorio(Date dataInicio, Date dataFim) {  
        try {
               ...
               JasperPrint jp;
               URL arquivo = getClass().getResource("/sistemaoficinamusica/report/despesasSituacao.jasper");
            ...
            Logger.getLogger(RelatorioDespesasSituacao.class.getName()).log(Level.SEVERE, null, ex);
        }
