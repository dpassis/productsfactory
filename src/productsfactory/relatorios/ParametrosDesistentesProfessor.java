 ...
 * @author Daniel
 */
public class ParametrosDesistentesProfessor extends javax.swing.JDialog {

    private static ParametrosDesistentesProfessor jDialogParametros = null;

    public static ParametrosDesistentesProfessor getDialogParametros(java.awt.Frame janela){

        if (jDialogParametros == null) {
            jDialogParametros = new ParametrosDesistentesProfessor(janela,true);
        }
        return jDialogParametros;
    }
    /** Creates new form ParametrosAlunoAtivoInativo */
    public ParametrosDesistentesProfessor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inicializa();
    }
...
// TODO add your handling code here:
    ...
    private void geraReport(){
            ...
            if(this.dtInicioPeriodo.getDate().after(this.dtTerminoPeriodo.getDate())){
                ...
                RelatorioDesistentesProfessor  relatorioDesistentesProfessor = new RelatorioDesistentesProfessor(this, true);
                this.dispose();
                relatorioDesistentesProfessor.geraRelatorio(this.dtInicioPeriodo.getDate(), this.dtTerminoPeriodo.getDate());
            }
